...
urlpatterns = patterns('',
    ...
    url(r'^write-default', WriteDefaultView.as_view(), name="write-default"),
    url(r'^write-car', WriteCarView.as_view(), name="write-car"),
    url(r'^write-house', WriteHouseView.as_view(), name="write-house"),
    url(r'^write-store', WriteStoreView.as_view(), name="write-store"),
